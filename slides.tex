...
\begin{frame}
  \begin{tikzpicture}[remember picture, overlay]
    ...
    ($(current page.south west) + (0.05\paperwidth, 0.05\paperwidth)$) {
      \color{b-grey}\href{https://twitter.com/phylorich}{@phylorich}
    };
...
% TODO: true diversity should be in grey.
\begin{frame}
  \inthemiddle{%
...
\begin{frame}
  ...
  \only<2>{\bottomleft{Jack William Bell: http://perl.plover.com/classes/git/samples/slide034.html}}
\end{frame}
